...
public class Servlet11 extends HttpServlet {
  ...
  protected void service(
    ...
    // 테스트 방법:
    // => http://localhost:8080/java-web/ex7/s11?a=100&b=200&op=%2b
    // => http://localhost:8080/java-web/ex7/s11?a=100&b=200&op=-
    // => http://localhost:8080/java-web/ex7/s11?a=100&b=200&op=*
    //
    ...
    RequestDispatcher 요청배달자 
        =  request.getRequestDispatcher("/ex07/s11_error");
    if (op.contentEquals("+")) {
    ...
    // => forward()는 다른 서블릿으로 실행을 위임한후 되돌아 오지 않지만,
    //   includ()는 다른 서블릿으로 실행을 위임한 후 되돌아 온다. 

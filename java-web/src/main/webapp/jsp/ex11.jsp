...
<body>
<h1>JSP 액션 태그 - jsp:useBean과 jsp:set</h1>
   ...
   scope
    ...
    id
     ...
     class
        ...
        - 객체를 생성할 때도 사용할 수 있기 때문에 반드시 콘크리트 클래스 명이어야 한다.

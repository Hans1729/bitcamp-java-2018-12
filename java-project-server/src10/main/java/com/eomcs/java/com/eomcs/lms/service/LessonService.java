...
public class LessonService {
  ...
  public void init(ObjectInputStream in, ObjectOutputStream out) { // 인스턴스 필드 와 인스턴스 메서드로 변환
    this.in = in;
    this.out = out;
  }
  ...
  public void loadData(String filepath) {
    ...
    try (ObjectInputStream in =
      ...
      throw new RuntimeException("수업 데이터의  파일 로딩 오류!", e);
    }
  ...
  public void saveData() throws Exception {
    try (ObjectInputStream in =
      ...
      throw new RuntimeException("수업 데이터의  파일 저장 오류!", e);
    }
  }

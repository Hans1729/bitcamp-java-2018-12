  ...
  public static void main(String[] args) {
   ...
   //java.lang 패키지의 멤버를 사용할 때는 그냥 이름을 지정하면 된다.
    ...
    System.out.printf("%1$tY, %ty\n", today);
     // B : 날짜 및 시각 데이터에서 월을 추출하여 전체 이름을 표현한다. ex) January
     // b : 날짜 및 시각 데이터에서 월을 추출하여 단축 이름을 표현한다.   ex) Jan
    System.out.printf("%1$tB, %tb\n", today);
    
    // m : 날짜 및 시각 데이터에서 월을 추출하여 2자리 숫자로 표현한다. ex) 12, 01
   System.out.printf("%1$tm\n", today);
   
   // d : 날짜 및 시각 데이터에서 일을 추출하여 2자리 숫자로 표현한다. ex) 01, 22
   // e : 날짜 및 시각 데이터에서 월을 추출하여 2자리 숫자로 표현한다. ex) 1,22
   System.out.printf("%1$td %1$te\n", today);
   // A : 날짜 및 시각 데이터에서 요일을 추출하여 긴 이름으로 표현한다. ex) Sunday
   // a : 날짜 및 시각 데이터에서 요일을 추출하여 긴 이름으로 표현한다. ex) Sun
   ...
   System.out.printf("%1$tM\n", today);
   // S : 날짜 및 시각 데이터에서 시각을 추출하여 초을 표현한다.
   // L : 날짜 및 시각 데이터에서 시각을 추출하여 밀리초을 표현한다.
   // N : 날짜 및 시각 데이터에서 시각을 추출하여 나노초을 표현한다.
   ...
   // 년-월-일 시:분:초를 출력하라.
   System.out.printf("%1$tY-%1$tm-%1$td\b %1$tH:%1$tM:%1$tS\n",today);

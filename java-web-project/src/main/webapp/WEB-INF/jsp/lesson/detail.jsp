   ...
   <div class="form-group row">
    ...
    <div class="col-sm-8">
      <textarea class="form-control" id="title" 
                name='title' rows='2'>${lesson.title}</textarea>
    </div>
  </div>
    ...
    <div class="col-sm-8">
      <textarea class="form-control" id="contents" 
                name='contents' rows='2'>${lesson.contents}</textarea>
    </div>
  </div>
  
    <div class="form-group row">
    <label for="contents" class="col-sm-2 col-form-label">시작일</label>
    <div class="col-sm-8">
      <input type='date' class="form-control" id="startDate" 
                name='startDate' >${lesson.startDate}
       </div>
    </div>
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type='number' class="form-control" id="totalHours" 
                name='totalHours' >${lesson.totalHours}
       </div>
    </div>
       <div class="form-group row">

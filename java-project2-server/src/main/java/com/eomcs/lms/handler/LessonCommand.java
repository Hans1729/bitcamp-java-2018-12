...
public class LessonCommand {
  ...
  public void list(ServletRequest request,ServletResponse response) throws Exception {
    ...
    out.println("<tr> <th>번호</th> <th>수업</th>  <th>시작/종료일</th>  <th>총교육기간</th> </tr>");
  ...
  public void detail(ServletRequest request, ServletResponse response) throws Exception {
    ...
    if (lesson == null) {
      ...
      out.printf("  <td><input type='text' name='title' readonly value='%s'></td>\n", lesson.getTitle());
      out.println("</tr>");
      ...
      out.println("<tr>");
      out.println("  <th>총교육시간</th>");
      out.printf("  <td><input type='number' name='totalHours'  value='%s'></td>\n", lesson.getTotalHours());
      out.println("</tr>");

      out.println("<tr>");
      out.println("  <th>일교육시간</th>");
      out.printf("  <td><input type='number' name='dayHours'  value='%s'></td>\n", lesson.getDayHours());
      out.println("</tr>");
  ...
  public void form(ServletRequest request, ServletResponse response) throws Exception {
    ...
    out.println("<tr>");
    out.println("  <th>내용</th>");
    out.println("  <td><input type='date' name='contents'></td>");
    out.println("</tr>");
    out.println("<tr>");
    out.println("  <th>시작일</th>");

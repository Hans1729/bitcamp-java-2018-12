...
public class MemberCommand {
  ...
  public void list(ServletRequest request,ServletResponse response) throws Exception {
    ...
    out.println("<tr> <th>번호</th> <th>제목</th>  <th>이메일</th> <th>전화번호</th> <th>등록일</th> </tr>");
  ...
  public void detail(ServletRequest request,ServletResponse response) throws Exception {
    ...
    if (member == null) {
      ...
      out.printf("  <td><input type='password' name='password' value='%s'></td>\n", member.getEmail());
      out.println("</tr>");
      ...
      out.printf("  <td><input type='text' name='registeredDate' value='%s'></td>\n", member.getRegisteredDate());
      out.println("</tr>");
  ...
  public void search(ServletRequest request,ServletResponse response) throws Exception {
    ...
    for (Member member : members) {
      out.println(String.format("<tr> <th>이름</th> <td>%d</td> </tr>",member.getNo()));
      out.println(String.format( "<tr> <th>이메일</th> <td>%s</td> </tr>", member.getName()));
      out.println(String.format( "<tr> <th>이메일</th> <td>%s</td> </tr>", member.getEmail()));
      out.println(String.format( "<tr> <th>전화</th> <td>%s</td> </tr>", member.getTel()));
      out.println(String.format( "<tr> <th>등록일</th> <td>%s</td> </tr>", member.getRegisteredDate()));
